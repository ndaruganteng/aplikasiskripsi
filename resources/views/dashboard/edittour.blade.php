                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ $tour->kuota}}" name="kuota" placeholder="Masukan Kuota Tour">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ $tour->tanggalberangkat}}" name="tanggalberangkat" placeholder="Tanggal Berangkat">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ $tour->tanggalberakhir}}" name="tanggalberakhir" placeholder="Tanggal berakhir">
                                            </div>
                                        </div>
                                    </div>
                                </div>
