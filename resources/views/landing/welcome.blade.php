        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            ...
            <div class="flex items-center">
                <a href="{{ route('login.index') }}"
                    class="text-base font-medium text-gray-900 dark:text-blue-500 hover:text-yellow-500">Login</a>
            </div>
        </div>
    </nav>
                ...
                <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                    ...
                    <li>
                        <a href="{{ route('tambahmitra.index') }}"
                            class="text-white dark:text-white hover:underline">Daftra Mitra</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="flex flex-wrap -m-2 ">
                <div class="p-2 lg:w-1/3 md:w-1/2 w-full   ">
                    <div class="h-full flex items-center  border-gray-200 border-2 p-4 rounded-lg">
                        <img alt="team"
                            ...
                            src="images/background/alam.jpg">
                        <div class="flex-grow">
                ...
                <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                    <div class="h-full flex items-center border-gray-200 border-2 p-4 rounded-lg">
                        <img alt="team"
                            class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                            src="images/background/sejarah.jpg">
                        <div class="flex-grow">
                ...
                <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                    <div class="h-full flex items-center border-gray-200 border-2 p-4 rounded-lg">
                        <img alt="team"
                            class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                            src="images/background/religi.jpg">
                        <div class="flex-grow">
    ...
    <section class="font-inter">
        <div class="container px-24 py-24 mx-auto">
            <div class="flex flex-wrap w-full mb-10 ">
                        ...
                        <div
                            ...
                            <a href="{{ route('detail-tour.index') }}">
                                <div class="relative overflow-hidden bg-no-repeat bg-cover">
                                    <img class=" rounded w-full object-cover hover:scale-110 transition duration-300 ease-in-out  object-center  "
                                        src="images/background/paket.jpg" alt="content">
                                </div>
                            </a>
                            <div class="p-5">
                                <div class="flex items-center justify-between">
                                    <h2
                                        class="tracking-widest text-md title-font font-medium italic text-gray-400 mb-1">
                                        24-05-2023</h2>
                                    <span
                                        class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Wisata
                                        Alam</span>
                                </div>

                                <a href="{{ route('detail-tour.index') }}">
                                    <h5
                                        class="mb-3 text-2xl font-bold tracking-tight text-gray-900 hover:text-gray-400 dark:text-white">
                                        Labuan Bajo</h5>
                                </a>
                                <p class="flex items-center text-gray-600 mb-2">
                                    <span
                                        class="w-4 h-4 mr-2 inline-flex items-center justify-center text-black  flex-shrink-0">
                    ...
                    <div class="xl:w-1/4 md:w-1/2 sm:w-1/1 p-4 mx-auto">
                        <div
                            ...
                            <a href="{{ route('detail-tour.index') }}">
                                <div class="relative overflow-hidden bg-no-repeat bg-cover">
                                    <img class=" rounded w-full object-cover hover:scale-110 transition duration-300 ease-in-out  object-center  "
                                        src="images/home/bali.jpg" alt="content">
                                </div>
                            </a>
                            <div class="p-5">
                                <div class="flex items-center justify-between">
                    ...
                    <div class="xl:w-1/4 md:w-1/2 sm:w-1/1 p-4 mx-auto">
                        <div
                            ...
                            <a href="{{ route('detail-tour.index') }}">
                                <div class="relative overflow-hidden bg-no-repeat bg-cover">
                                    <img class=" rounded w-full object-cover hover:scale-110 transition duration-300 ease-in-out  object-center  "
                                        src="images/home/lombok.jpg" alt="content">
                                </div>
                            </a>
                            <div class="p-5">
                                <div class="flex items-center justify-between">
                                ...
                                <p class="flex items-center text-gray-600 mb-2">
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M14.55 16.55L11 13V8h2v4.175l2.95 2.95ZM11 6V4h2v2Zm7 7v-2h2v2Zm-7 7v-2h2v2Zm-7-7v-2h2v2Zm8 9q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 
                                            14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 
                                            3.175-2.138Q9.925 2 12 
                                            2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Zm0-2q3.35 0 5.675-2.325Q20 15.35 20 12q0-3.35-2.325-5.675Q15.35 4 12 4Q8.65 4 6.325 6.325Q4 8.65 4 12q0 3.35 2.325 5.675Q8.65 20 12 20Zm0-8Z" />
                                        </svg>
                                    </span>4 Hari - 3 Malam
                                </p>
                                <p class="mb-2 font-normal text-gray-400 dark:text-gray-400">Start From</p>
                ...
                <a href="#"
                    class="flex mx-auto mt-12 text-white bg-yellow-500  py-2 px-8 focus:outline-none hover:text-white hover:bg-gray-900 rounded-lg text-lg">Jelajah
                    Lainnya</a>
            </div>
        </div>
    </section>
    ...
    <footer class="p-4 bg-white rounded-lg shadow md:px-6 lg:px-24 md:py-8 dark:bg-gray-900">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="{{ route('home.index') }}" class="flex items-center mb-4 sm:mb-0">
                ...
                <span
                    class="self-center text-gray-900 text-2xl font-bold whitespace-nowrap dark:text-white">Thelema</span>
            </a>
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 3 <a href="#"
                class="hover:underline">Thelema</a>. All Rights
            Reserved.
        </span>
    </footer>
