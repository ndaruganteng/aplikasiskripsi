...
<html>
    ...
    <section class="text-gray-600 body-font">
            <div class="container px-40 pt-10 mx-auto">
                <div class="">
                    <h1 class="sm:text-3xl lg:text-3xl font-semibold title-font text-gray-900">Daftar Pesanan</h1>
                </div>
            </div>
        </section>
        <section class="text-gray-600 body-font">
            <div class="container px-40 pt-6 mx-auto">
                <div class="flex flex-wrap -m-4">
                    <div class="p-4 w-full mx-auto ">
                        <div class=" bg-white p-4 mx-auto rounded-lg">
                            <div class="text-center mb-6">
                                <h1 class="sm:text-3xl text-2xl font-semibold title-font  mb-2">Metode Pembayaran </h1>
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-40 pt-6 pb-40 mx-auto">
                <div class="flex flex-wrap -m-4">
                        ...
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 ">
                                ...
                                @foreach($pemesanan as $p)
                                    <tr class="bg-white text-center items-center border-b ">
